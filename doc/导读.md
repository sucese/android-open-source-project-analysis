...
好了，以上便是我们开始分析Android源码所需的全部准备工作，这个系列的文章已经开始有几个月了，Android显示框架的相关内容已经完成，其他的也在进行中，

具体可以关注[Android Open Source Project Analysis](https://github.com/guoxiaoxing/android-open-source-project-analysis).